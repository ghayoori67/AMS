...
namespace AMS.Migrations
{
    ...
    [Migration("20230924110906_add_UserPayment_Entity")]
    partial class add_UserPayment_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMS.PaymentPlans.PaymentPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMS.ReplyTickets.TicketMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMS.Tickets.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMS.UserPayments.UserPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMS.PaymentPlans.PaymentPlan", b =>
                {
                    b.HasOne("AMS.UserPayments.UserPayment", null)
            ...
            modelBuilder.Entity("AMS.ReplyTickets.TicketMessage", b =>
                {
                    ...
                    b.HasOne("AMS.Tickets.Ticket", "Ticket")
                        .WithMany("TicketMessages")
            ...
            modelBuilder.Entity("AMS.Tickets.Ticket", b =>
                {
                    b.HasOne("AMS.Authorization.Users.User", "User")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AMS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AMS.Authorization.Users.User", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
