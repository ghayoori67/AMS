...
{
    public abstract class AMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AMSDbContext, Task<T>> func)
        {
            T result;
